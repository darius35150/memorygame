...
const appleIcon = "../images/apple1.png";
const butterflyIcon = "../images/butterfly1.png";
const carIcon = "../images/car1.png";
const catIcon = "../images/cat1.png";
const cloudIcon = "../images/cloud1.png";
const diceIcon = "../images/dice1.png";
const duckIcon = "../images/duck1.png";
const feetIcon = "../images/feet1.png";
const flakeIcon = "../images/flake1.png";
const flowerIcon = "../images/flower1.png";
const frogIcon = "../images/frog1.png";
const giftIcon = "../images/gift1.png";
const heartIcon = "../images/heart1.png";
const houseIcon = "../images/house1.png";
const ladybugIcon = "../images/ladybug1.png";
const leavesIcon = "../images/leaves1.png";
const mushroomIcon = "../images/mushroom1.png";
const owlIcon = "../images/owl1.png";
const pencilIcon = "../images/pencil1.png";
const rainbowIcon = "../images/rainbow1.png";
const roseIcon = "../images/rose1.png";
const sprinklerIcon = "../images/sprinkler1.png";
const sunIcon = "../images/sun1.png";
const treeIcon = "../images/tree1.png";
const umbrellaIcon = "../images/umbrella1.png";
